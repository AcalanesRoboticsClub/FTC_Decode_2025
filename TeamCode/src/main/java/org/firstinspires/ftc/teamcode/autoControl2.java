...
@Autonomous
public class autoControl2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        flywheelRotateMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);  // Reset the motor encoder so that it reads zero ticks
        flywheelMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);  // Reset the motor encoder so that it reads zero ticks
...
//        backDistanceSensor = hardwareMap.get(DistanceSensor.class, "backDistanceSensor");
        ...
        if (opModeIsActive()) { // Used to be a while loop
            ...
            telemetry.addData("Auto Status : ", "Moving forward to first ball");
